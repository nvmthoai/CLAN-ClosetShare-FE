        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto max-h-screen">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent mb-2">Tạo tài khoản</h2>
            ...
            <form className="space-y-5" onSubmit={onSubmit}>
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-900 mb-2">
                  <span className="text-blue-600">Họ và tên</span>
                </label>
                <Input 
                  id="name" 
                  value={name} 
            ...
            <div className="text-center mt-6 text-sm">
              ...
              <Link to="/login" className="text-gray-900 hover:text-blue-500 transition-colors font-medium">
                Đăng nhập
              </Link>
            </div>
          </div>
